...
"""Renderer of the classic Barnsley J2 fractal."""
...
def main():
    ...
    print("Calculation started")
    t1 = time()
    recalc_fractal(image, palette_gold.palette, -1.5, -1.5, 1.5, 1.5, -1.0, 1.0, 500)
    image.save("barnsley_j2_3.png")
    t2 = time()
    difftime = t2 - t1
    print(f"Calculation finished in {difftime:4.1f} seconds")
