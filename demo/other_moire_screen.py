...
class OtherMoireScreen(Screen):
    ...
    def calcImage(self) -> Surface:
        threshold = self._zoom * OtherMoireScreen.RELATIVE_ZOOMS[self._function] #(2 << 5) + 50.0 * self._zoom
        image = Image.new("RGB", (OtherMoireScreen.IMAGE_WIDTH, OtherMoireScreen.IMAGE_HEIGHT))
